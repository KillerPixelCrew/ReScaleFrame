...
[Binary analysis tooling](ghidra-tooling.md) covers the Ghidra tooling this project had to write and records why the shipped executable cannot be analysed statically.
